...
Not inherently from Nova, but another selection of tools created by 7ames, including a python operating system GUI and window manager, endpoint-based terminal tools and API, and an ubuntu-based linux distro. Find all of this and more at [kebab-os](https://github.com/kebab-os).
